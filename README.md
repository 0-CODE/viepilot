...
[![Templates](https://img.shields.io/badge/templates-15-cyan.svg)](#templates)
...
| Skills | 10 |
| Workflows | 8 |
| Templates | 15 (Project: 10, Phase: 5) |
| CLI Commands | 12 |
...
| Project Templates | 10 | AI-GUIDE, ARCHITECTURE, SYSTEM-RULES, etc. |
...
│   ├── project/                   # 10 Project-level templates
│   │   ├── AI-GUIDE.md
│   │   ├── PROJECT-META.md
│   │   ├── ARCHITECTURE.md
│   │   ├── PROJECT-CONTEXT.md
...
```bash
# Fork và clone
git clone https://github.com/your-username/viepilot.git
cd viepilot
