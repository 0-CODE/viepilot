...
[![Tests](https://img.shields.io/badge/tests-1021%20passing-brightgreen.svg)](tests/)
[![GitHub](https://img.shields.io/github/stars/0-CODE/viepilot?style=social)](https://github.com/0-CODE/viepilot)

**Versioning:** Shield **2.18.0** is the **ViePilot framework SemVer** tracked in `.viepilot/TRACKER.md` and `CHANGELOG.md`. The npm `package.json` field `version` (**2.18.0**) is the Node package identifier for this repo; use the framework version for milestone releases and docs.
