...
Project website: https://viepilot.creps.vn
...
Current planning focus: the `.viepilot/` workspace is now seeded for a **v3 compiler-runtime refactor** while the published package baseline remains **v2.2.3**.
