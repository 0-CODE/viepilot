...
┌─────────────────────────────────────────────────────────────────────────┐
│                            CLI LAYER                                    │
│  vp-tools.cjs (13 commands) + viepilot.cjs (install → lib Node; ENH-017)  │
...
| Quality | audit | Documentation sync and gap detection |
...
Quality Assurance:
audit.md ──────► Sync docs with implementation (manual or auto-hook)
```
