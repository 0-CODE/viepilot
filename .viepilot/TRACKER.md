...
- **Next Phase**: **163** (planned — DEBT-004 brittle-test cleanup → **v3.22.1** PATCH; 4 tasks; **runs first** for a green baseline). Then **162** (planned — ENH-114 vp-qa `--live` → **v3.23.0** MINOR from 3.22.1; 4 tasks). Execution order: 163 → 162 (SemVer: 3.22.0 →patch→ 3.22.1 →minor→ 3.23.0).
