...
<!-- This section is auto-generated by vp-crystallize when deployment_signals are detected.
     If your project has Dockerfile, GitHub Actions, GitLab CI, or other CI/CD files,
     vp-crystallize will append a project-specific checklist here listing all files where
     version strings must be updated when running /vp-evolve.

     If this section is absent, your project has no detected CI/CD infrastructure,
     or vp-crystallize was run before ENH-104 (re-run: /vp-crystallize --upgrade).
-->
